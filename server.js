...
async function runPULSE() {
  ...
  console.log(`⚡ PULSE #${empireState.pulseCount} — Brain:${brain.status} Quantum:${quantum.status} TITAN:${titan.status} | Empire P&L: $${empireState.empirePnl.toFixed(2)}`);
}
...
Empire regime: ${empireState.empireRegime}
Bot performance: Brain WR:${empireState.bots.brain.winRate?.toFixed(1)}% | Quantum WR:${empireState.bots.quantum.winRate?.toFixed(1)}% | TITAN WR:${empireState.bots.titan.winRate?.toFixed(1)}%
...
- Brain: ${empireState.bots.brain.totalTrades} trades, ${empireState.bots.brain.winRate?.toFixed(1)}% WR, $${empireState.bots.brain.pnl?.toFixed(2)} P&L
- Quantum: ${empireState.bots.quantum.totalTrades} trades, ${empireState.bots.quantum.winRate?.toFixed(1)}% WR, $${empireState.bots.quantum.pnl?.toFixed(2)} P&L  
- TITAN: ${empireState.bots.titan.totalTrades} trades, ${empireState.bots.titan.winRate?.toFixed(1)}% WR, $${empireState.bots.titan.pnl?.toFixed(2)} P&L
